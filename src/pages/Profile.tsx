    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="rounded-xl p-5 border" style={{ backgroundColor: 'var(--card)', borderColor: 'var(--border)' }}>
        ...
        {focusActive ? (
          ...
          <button onClick={startFocusTimer} className="w-full px-4 py-3 rounded-xl text-sm font-semibold min-h-[48px]" style={{ backgroundColor: 'var(--brand)', color: 'var(--brand-text)' }}>
